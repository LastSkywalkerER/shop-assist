...
export function useRxCollection<T>(
  name: 'products' | 'stores' | 'purchases' | 'expenseCategories' | 'expenses' | 'expenseParticipants' | 'receipts' | 'receiptItems' | 'expenseAttachments' | 'shoppingListItems' | 'purchaseAttachments' | 'currencyRates'
): RxCollection<T> | null {
